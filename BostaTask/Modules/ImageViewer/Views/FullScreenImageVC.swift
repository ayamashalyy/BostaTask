...
class FullScreenImageVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dismissButton.anchorWidth(equalToConstant: 50)
        dismissButton.anchorHeight(equalToConstant: 50)
        dismissButton.anchorXAxis(leading: imageView.leadingAnchor, leadingConstant: 20)
        dismissButton.anchorYAxis(top: imageView.topAnchor)
        
        shareButton.anchorWidth(equalToConstant: 50)
        shareButton.anchorHeight(equalToConstant: 50)
        shareButton.anchorXAxis(trailing: imageView.trailingAnchor, trailingConstant: -20)
        shareButton.anchorYAxis(top: imageView.topAnchor)
